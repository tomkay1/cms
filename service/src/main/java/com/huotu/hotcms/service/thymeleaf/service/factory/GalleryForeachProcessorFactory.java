 ...
 */
public class GalleryForeachProcessorFactory {

    private final int DEFAULT_PAGE_NO = 1;
    private final int DEFAULT_PAGE_SIZE = 12;
    private final int DEFAULT_PAGE_NUMBER = 5;

    private static Log log = LogFactory.getLog(GalleryForeachProcessorFactory.class);

    private static GalleryForeachProcessorFactory instance;

    private GalleryForeachProcessorFactory(){}

    public static GalleryForeachProcessorFactory getInstance() {
        if(instance == null) {
            instance = new GalleryForeachProcessorFactory();
        }
        return instance;
    }
    ...
    public Object process(IProcessableElementTag elementTag,ITemplateContext context) {
        ...
        try {
            ...
            PageableForeachParam galleryForeachParam = DialectAttributeFactory.getInstance().getForeachParam(elementTag, PageableForeachParam.class);
            ...
            GalleryService galleryService = (GalleryService)applicationContext.getBean("galleryServiceImpl");
