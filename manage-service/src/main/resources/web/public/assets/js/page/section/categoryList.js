        ...
        require.async(['jqxdata','jqxbuttons','jqxscrollbar','jqxdatatable','jqxtreegrid'], function() {
            ...
            var categoryModule={
                ...
                openUpdateCategory:function(id,title,type){
                    ...
                    var content='/manage/category/addCategory/?id='+id+"&siteId="+siteId+"&customerid="+customerId //iframe的url
                    if(type==2){
                        content='/manage/category/updateCategory/?id='+id+"&customerid="+customerId //iframe的url
                    }
                    layer.open({
                        type: 2,
                        title: title,
