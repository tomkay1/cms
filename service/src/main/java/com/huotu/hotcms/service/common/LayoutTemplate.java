...
public enum LayoutTemplate implements CommonEnum {
    THREE_COLUMN_LAYOUT_190x590x190(0, "<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    WITHOUT_COLUMN_LAYOUT_990(1,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    LEFT_RIGHT_COLUMN_LAYOUT_190x790(2,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\" >\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    RIGHT_PART_LAYOUT_190x390x390(3,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\">\n" +
            "      <div class=\"layout-three-left w190\" name=\"left\" style=\"margin-bottom:20px;\">\n" +
            "       <div class=\"layout-tool HOT-tool\">%s" +
            "        </div>" +
            ...
            "    </div>\n" +
            "  </div>"),
    LEFT_RIGHT_COLUMN_LAYOUT_790x190(4,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    LEFT_PART_LAYOUT_390x390x190(5,"<div class=\"layouttarea HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    THREE_COLUMN_LAYOUT_254x717x239(6, "<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    LEFT_RIGHT_COLUMN_LAYOUT_254x956(7,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\" style=\"width:1210px;\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    LEFT_RIGHT_COLUMN_LAYOUT_272x718(8,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    LEFT_RIGHT_COLUMN_LAYOUT_215x765(9,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    LEFT_RIGHT_COLUMN_LAYOUT_330x650(10,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    LEFT_RIGHT_COLUMN_LAYOUT_650x330(11,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    LEFT_RIGHT_PART_LAYOUT_490x490(12,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    LEFT_CENTER_RIGHT_PART_LAYOUT_323x324x323(13,"<div class=\"layout-area HOT-layout-area js-layout\">\n" +
            "    <div class=\"layout HOT-layout layout-box\">\n" +
            ...
            "    </div>\n" +
            "  </div>"),
    WITHOUT_COLUMN_LAYOUT_99999(14, "<div class=\"layout-area HOT-layout-area js-layout\">\n" +
